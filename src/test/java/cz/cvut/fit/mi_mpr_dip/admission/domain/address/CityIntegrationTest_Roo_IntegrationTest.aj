...
import cz.cvut.fit.mi_mpr_dip.admission.domain.address.CityIntegrationTest;
...
privileged aspect CityIntegrationTest_Roo_IntegrationTest {
    ...
    public void CityIntegrationTest.testMergeUpdate() {
        ...
        obj.flush();
        Assert.assertEquals("Identifier of merged object not the same as identifier of original object", merged.getCityId(), id);
