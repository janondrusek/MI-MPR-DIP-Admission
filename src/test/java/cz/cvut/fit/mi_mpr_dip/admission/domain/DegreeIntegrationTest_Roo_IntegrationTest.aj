...
import cz.cvut.fit.mi_mpr_dip.admission.domain.DegreeIntegrationTest;
...
privileged aspect DegreeIntegrationTest_Roo_IntegrationTest {
    ...
    public void DegreeIntegrationTest.testFindDegree() {
        ...
        Assert.assertEquals("Find method for 'Degree' returned the incorrect identifier", id, obj.getId());
    }
    ...
    public void DegreeIntegrationTest.testPersist() {
        ...
        Assert.assertNull("Expected 'Degree' identifier to be null", obj.getId());
        obj.persist();
        obj.flush();
        Assert.assertNotNull("Expected 'Degree' identifier to no longer be null", obj.getId());
    }
